...
from src.CNNs.utils.image import flip, color_aug
from src.CNNs.utils.image import get_affine_transform, affine_transform
from src.CNNs.utils.image import gaussian_radius, draw_umich_gaussian
import copy
...
class GenericDataset(data.Dataset):
  ...
  def __getitem__(self, index):
    ...
    # print(opt.input_w, opt.input_h, opt.output_w, opt.output_h)
    # print(c, s, rot)
