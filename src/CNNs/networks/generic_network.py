...
from src.CNNs.networks.backbones.dla import dla34
from src.CNNs.networks.backbones.resnet import Resnet
from src.CNNs.networks.backbones.mobilenet import MobileNetV2
from src.CNNs.networks.necks.dlaup import DLASeg
from src.CNNs.networks.necks.msraup import MSRAUp
...
class GenericNetwork(nn.Module):
    def __init__(self, num_layers, heads, head_convs, num_stacks=1, opt=None):
        ...
        self.neck = DLASeg(opt=opt, channels=channels)
