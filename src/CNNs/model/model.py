...
from src.CNNs.networks.dla import DLASeg
from src.CNNs.networks.resdcn import PoseResDCN
from src.CNNs.networks.resnet import PoseResNet
from src.CNNs.networks.dlav0 import DLASegv0
from src.CNNs.networks.generic_network import GenericNetwork
