...
def main():
    ...
    AOI_string = 'AOIs'
    for aoi in AOIs:
        AOI_string = AOI_string + '_' + str(aoi).zfill(2)

    for MOVING_DATA_ONLY in [False]:
        img_direcotories = ['C:/Users/caguilar/Desktop/aguilar-camilo/Codes/FRONTIERS/dataset/AFRL_Dataset/AOI_' + str(aoi_n).zfill(2) + '/INPUT_DATA/stabilized_data' for aoi_n in AOIs]        
        
        if MOVING_DATA_ONLY:
            csv_directories = ['C:/Users/caguilar/Desktop/aguilar-camilo/Codes/FRONTIERS/dataset/AFRL_Dataset/AOI_' + str(aoi_n).zfill(2) + '/GT/transformed_object_states_moving_objects_only.csv' for aoi_n in AOIs]
            output_name = 'C:/Users/caguilar/Desktop/aguilar-camilo/Codes/FRONTIERS/dataset/AFRL_Dataset/transformed_object_states_moving_objects_only_' + AOI_string + '.json'
        else:
            csv_directories = ['C:/Users/caguilar/Desktop/aguilar-camilo/Codes/FRONTIERS/dataset/AFRL_Dataset/AOI_' + str(aoi_n).zfill(2) + '/GT/transformed_object_states.csv' for aoi_n in AOIs]
            output_name = 'C:/Users/caguilar/Desktop/aguilar-camilo/Codes/FRONTIERS/dataset/AFRL_Dataset/transformed_object_states_' + AOI_string + '.json'
        ...
        for video_idx in range(len(img_direcotories)):
            current_AOI = str(AOIs[video_idx]).zfill(2)
            ...
            for file_n in file_names:
                ...
                file_n = 'AOI_' + current_AOI + '/INPUT_DATA/stabilized_data/' + file_n
        ...
        print("WRITTING JSON")
        write_json(mot_format_dictionary, output_name)#"test_AOI_" + AOI + "_moving_only.json")
        print("DONE")
