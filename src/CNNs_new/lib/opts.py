...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--debugger_theme', default='white', 
                             choices=['white', 'black'])
    self.parser.add_argument('--eval_val', action='store_false')
    ...
    self.parser.add_argument('--save_point', type=str, default='3',
    ...
    # Tracking
    self.parser.add_argument('--tracking', action='store_false')
    self.parser.add_argument('--pre_hm', action='store_false')
    self.parser.add_argument('--same_aug_pre', action='store_false')
    ...
    self.parser.add_argument('--hm_weight', type=float, default=3,
